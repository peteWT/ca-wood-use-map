...
def hello():
    ...
    qry=[ast.literal_eval(i[0]) for i in db.query('select row_to_json(t)::text from (select ogc_fid, milltype, facilityna,st_asgeojson(st_transform(wkb_geometry,4326))::json geom from ca2012) t','cfor')]
